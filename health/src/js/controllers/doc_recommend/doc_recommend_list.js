...
angular.module('app').controller('DocRecommendList', DocRecommendList);

DocRecommendList.$inject = ['$scope', 'utils', '$http', 'toaster', '$location', '$state', '$rootScope', '$stateParams', '$modal'];

function DocRecommendList($scope, utils, $http, toaster, $location, $state, $rootScope, $stateParams, $modal) {
