'use strict';
(function(){
    app.controller('ContactsListAdd',funcContactsListAdd);
    funcContactsListAdd.$inject=['$rootScope', '$scope', '$state', '$timeout', '$http', 'utils'];
    function funcContactsListAdd($rootScope, $scope, $state, $timeout, $http, utils) {
