...
(function(){
    //集团LOGO设置控制器
    app.controller('groupLogoCtrl',funcgroupLogoCtrl);
    funcgroupLogoCtrl.$inject=['$scope', '$modal', '$log', '$http', 'Upload','$stateParams','$state','$rootScope','toaster','utils'];
    function funcgroupLogoCtrl($scope, $modal, $log, $http, Upload,$stateParams,$state,$rootScope,toaster,utils){
