'use strict';
(function(){
    app.controller('RelationshipEdit',funcRelationshipEdit);
    funcRelationshipEdit.$inject=['$rootScope', '$scope', '$state', '$timeout', '$http', 'utils', 'modal'];
    function funcRelationshipEdit($rootScope, $scope, $state, $timeout, $http, utils, modal) {
