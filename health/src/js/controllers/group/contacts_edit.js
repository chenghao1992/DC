'use strict';
(function(){
    app.controller('ContactsEdit',funcContactsEdit);
    funcContactsEdit.$inject=['$rootScope', '$scope', '$state', '$timeout', '$http', 'utils', 'modal'];
    function funcContactsEdit($rootScope, $scope, $state, $timeout, $http, utils, modal) {
