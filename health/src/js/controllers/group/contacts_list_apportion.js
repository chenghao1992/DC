'use strict';
(function(){
    app.controller('ContactsListApportion',funcContactsListApportion);
    funcContactsListApportion.$inject=['$rootScope', '$scope', '$state', '$timeout', '$http', 'utils'];
    function funcContactsListApportion($rootScope, $scope, $state, $timeout, $http, utils) {
