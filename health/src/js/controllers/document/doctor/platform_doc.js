...
angular.module('app').controller('PlatCtrl', PlatCtrl);
PlatCtrl.$inject = ['$scope', '$timeout','utils','$http','modal','toaster','$location','$state'];
function PlatCtrl($scope, $timeout,utils,$http,modal,toaster,$location,$state) {
            ...
            platArticleTable = $('#doc_list').DataTable({
                ...
                "createdRow": function (nRow, aData, iDataIndex) {
                    ...
                    $(nRow).on('click','', function (event) {
                        ...
                        var url = $state.href('doctorArticle', {id: aData.id,createType:5});
