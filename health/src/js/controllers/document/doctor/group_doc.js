...
GroupCtrl.$inject = ['$scope', '$timeout','utils','$http','modal','toaster','$location','$state'];
function GroupCtrl($scope, $timeout,utils,$http,modal,toaster,$location,$state) {
            ...
            platArticleTable = $('#doc_list').DataTable({
                ...
                "createdRow": function (nRow, aData, iDataIndex) {
                    ...
                    $(nRow).on('click','', function (event) {
                        var url = $state.href('doctorArticle', {id: aData.id,createType:6});
