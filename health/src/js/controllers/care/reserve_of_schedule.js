...
//日程题库
angular.module('app').controller('ReserveSfScheduleCtrl', ReserveSfScheduleCtrl);

ReserveSfScheduleCtrl.$inject = ['$rootScope', '$scope', '$state', '$http', '$compile', 'utils', '$modal', 'toaster'];

function ReserveSfScheduleCtrl($rootScope, $scope, $state, $http, $compile, utils, $modal, toaster) {
...
viewPopCtrl.$inject = ['$rootScope', '$scope', '$modalInstance', '$http', 'utils', 'viewData'];

function viewPopCtrl($rootScope, $scope, $modalInstance, $http, utils, viewData) {
