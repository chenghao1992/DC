...
//日程题库
angular.module('app').controller('NewFollowUpCtrl', NewFollowUpCtrl);

NewFollowUpCtrl.$inject = ['$rootScope', '$scope', '$state', '$http', '$stateParams', '$compile', 'utils', '$modal', 'toaster'];

function NewFollowUpCtrl($rootScope, $scope, $state, $http, $stateParams, $compile, utils, $modal, toaster) {
...
// 设置提醒内容
angular.module('app').controller('NewFollowUp_TextDialogCtrl', NewFollowUp_TextDialogCtrl);

NewFollowUp_TextDialogCtrl.$inject = ['$scope', '$modalInstance', 'toaster'];

function NewFollowUp_TextDialogCtrl($scope, $modalInstance, toaster) {
...
// 调整时间
angular.module('app').controller('NewFollowUp_TimeDialogCtrl', NewFollowUp_TimeDialogCtrl);

NewFollowUp_TimeDialogCtrl.$inject = ['$scope', '$modalInstance', 'toaster', 'data'];

function NewFollowUp_TimeDialogCtrl($scope, $modalInstance, toaster, data) {
...
//选择病种弹窗
angular.module('app').controller('NewFollowUp_DiseaseSelected', NewFollowUp_DiseaseSelected);

NewFollowUp_DiseaseSelected.$inject = ['$rootScope', '$scope', '$modalInstance', '$http', 'utils', 'toaster'];

function NewFollowUp_DiseaseSelected($rootScope, $scope, $modalInstance, $http, utils, toaster) {
...
// 添加调查表或生活量表
angular.module('app').controller('NewFollowUp_AddListCtrl', NewFollowUp_AddListCtrl);

NewFollowUp_AddListCtrl.$inject = ['$rootScope', '$scope', '$modalInstance', '$state', '$http', 'toaster', 'data'];

function NewFollowUp_AddListCtrl($rootScope, $scope, $modalInstance, $state, $http, toaster, data) {
...
// 添加教患资料
angular.module('app').controller('NewFollowUp_docModalInstanceCtrl', NewFollowUp_docModalInstanceCtrl);

NewFollowUp_docModalInstanceCtrl.$inject = ['$scope', '$modalInstance', 'toaster', '$http', 'utils'];

function NewFollowUp_docModalInstanceCtrl($scope, $modalInstance, toaster, $http, utils) {
