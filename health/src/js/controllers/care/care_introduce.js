...
angular.module('app').controller('CareIntroCtrl', CareIntroCtrl);

CareIntroCtrl.$inject = ['$scope', '$timeout', 'utils', '$http', '$modal', 'Upload', 'toaster', '$state', '$stateParams', '$sce'];

function CareIntroCtrl($scope, $timeout, utils, $http, $modal, Upload, toaster, $state, $stateParams, $sce) {
    $scope.titleLength = 0;
