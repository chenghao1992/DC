...
//健康关怀列表
// angular.module('app').controller('CarePlanListCtrl', CarePlanListCtrl);
//
// CarePlanListCtrl.$inject = ['$rootScope', '$scope', '$state', '$http', '$compile', 'utils', 'modal', 'toaster'];
//
// function CarePlanListCtrl($rootScope, $scope, $state, $http, $compile, utils, modal, toaster) {
//     console.log(1);
//     //生成病种树
...
//关怀计划列表
angular.module('app').controller('CarePlanLibraryCtrl', CarePlanLibraryCtrl);

CarePlanLibraryCtrl.$inject = ['$scope', '$state', '$http', 'toaster', '$modal'];

function CarePlanLibraryCtrl($scope, $state, $http, toaster, $modal) {
    // console.log(1);
