...
angular.module('app').controller('FollowUpCtrl', FollowUpCtrl);

FollowUpCtrl.$inject = ['$scope', '$http', 'toaster', '$modal', '$stateParams', 'EditCareInfoFtory','AddCareRemindFtory', 'AddMedicationFtory', 'AddCareCheckRemindFtory', 'AddLifeQualityFtory', 'AddSurveyFtory', 'AddTextFtory', 'AddCheckDocReplyFtory', 'AddIllnessTrackFtory', 'AddArticleFtory'];

function FollowUpCtrl($scope, $http, toaster, $modal, $stateParams, EditCareInfoFtory, AddCareRemindFtory, AddMedicationFtory, AddCareCheckRemindFtory, AddLifeQualityFtory, AddSurveyFtory,AddTextFtory, AddCheckDocReplyFtory, AddIllnessTrackFtory, AddArticleFtory) {
    ...
    //添加文章
    $scope.addText=function(dateSeq, schedulePlanId, surveyId, sendTime, surveyItem){
        var addTextData={
            id: surveyId || null,
            carePlanId: $scope.planData.id || null,
            dateSeq: dateSeq,
        ...
        AddTextFtory.open(addTextData, callBack);
