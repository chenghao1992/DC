'use strict';
(function() {
    angular.module('app').factory('AddArticleFtory', AddArticleFtory);

    // 手动注入依赖
    AddArticleFtory.$inject = ['$http', '$modal', 'toaster'];

    function AddArticleFtory($http, $modal, toaster) {
        return {
            open: openModel
        };
    ...
    angular.module('app').controller('AddArticleCtrl', AddArticleCtrl);

    AddArticleCtrl.$inject = ['$scope', '$http', '$modal', '$modalInstance', 'toaster','utils', 'artilceData'];
