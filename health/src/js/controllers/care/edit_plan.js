...
//新建关怀计划
angular.module('app').controller('EditCarePlanCtrl', EditCarePlanCtrl);

EditCarePlanCtrl.$inject = ['$rootScope', '$scope', '$state', '$http', '$compile', 'utils', '$modal', 'toaster', '$stateParams'];

function EditCarePlanCtrl($rootScope, $scope, $state, $http, $compile, utils, $modal, toaster, $stateParams) {
