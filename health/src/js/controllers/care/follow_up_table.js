...
//日程题库
angular.module('app').controller('FollowUpTableCtrl', FollowUpTableCtrl);

FollowUpTableCtrl.$inject = ['$rootScope', '$scope', '$state', '$http', '$compile', 'utils', '$modal', 'toaster'];

function FollowUpTableCtrl($rootScope, $scope, $state, $http, $compile, utils, $modal, toaster) {
...
//添加随访
angular.module('app').controller('viewPopCtrl', viewPopCtrl);

viewPopCtrl.$inject = ['$rootScope','$scope', '$modalInstance', '$state', '$http', 'utils', 'toaster'];

function viewPopCtrl($rootScope, $scope, $modalInstance, $state, $http, utils, toaster) {
    $scope.viewName = "添加随访"
...
//详情弹窗
angular.module('app').controller('ifonPopCtrl', ifonPopCtrl);

ifonPopCtrl.$inject = ['$rootScope','$scope', '$modalInstance', '$sce', '$state', '$http', 'utils', 'toaster', 'viewData'];

function ifonPopCtrl($rootScope, $scope, $modalInstance, $sce, $state, $http, utils, toaster, viewData) {
...
//关怀计划列表
angular.module('app').controller('FollowUpLibraryCtrl', FollowUpLibraryCtrl);

FollowUpLibraryCtrl.$inject = ['$scope', '$state', '$http', 'toaster'];

function FollowUpLibraryCtrl($scope, $state, $http, toaster) {
    // console.log(1);
