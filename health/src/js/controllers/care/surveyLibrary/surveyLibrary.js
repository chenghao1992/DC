...
//调查表列表
angular.module('app').controller('SurveyLibraryCtrl', SurveyLibraryCtrl);

SurveyLibraryCtrl.$inject = ['$scope', '$state', '$http', 'toaster'];

function SurveyLibraryCtrl($scope, $state, $http, toaster) {
    // console.log(1);
