...
'use strict';
(function() {
    angular.module('app').controller('dynamicSendMsgCtrl', funDynamicSendMsgCtrl);
    ...
    function funDynamicSendMsgCtrl($scope, $http, $state, toaster, $stateParams, $modal) {
        ...
        //新增集团动态
        $scope.addGroupDynamicForWeb = function() {
            //参数校对
            ...
            //调用添加就医知识接口    
            $http.post(app.url.dynamic.addGroupDynamicForWeb, {
            ...
            success(function(data) {
                if (data.resultCode == 1) {
                    ...
                    setTimeout(function() {
                        $state.go('app.dynamic.edit.msgHistory', {}, { reload: true });
                    }, 3000);
