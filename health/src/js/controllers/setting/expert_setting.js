...
'use strict';
(function(){
    app.controller('ExpertSettingCtrl',funcExpertSettingCtrl);
    funcExpertSettingCtrl.$inject=['$rootScope', '$scope', '$state', '$http', '$compile', 'utils', 'modal','toaster'];
    function funcExpertSettingCtrl($rootScope, $scope, $state, $http, $compile, utils, modal,toaster) {
