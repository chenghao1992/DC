...
(function(){
    app.controller('HelperAccountCtrl',funcHelperAccountCtrl);
    funcHelperAccountCtrl.$inject=['$scope','utils','$http','$modal','toaster','$location','$state','$rootScope','$stateParams','$filter'];
    function funcHelperAccountCtrl($scope,utils,$http,$modal,toaster,$location,$state,$rootScope,$stateParams,$filter) {
        getGuiderList();
    ...
    app.controller('addGuiderInstanceCtrl',['$scope', '$modalInstance','toaster','$http','utils', function ($scope, $modalInstance,toaster,$http,utils) {
        $scope.addGuiderAccount=function(){
            ...
            $http.post(app.url.account.register, {
                ...
                name:$scope.name,
                userType:6,
                loginGroupId:localStorage.getItem('curGroupId')
            }).
            success(function(data, status, headers, config) {
                if(data.resultCode==1){
    ...
    app.controller('guiderInfoInstanceCtrl',['$scope', '$modalInstance','toaster','$http','item' ,function ($scope, $modalInstance,toaster,$http,item) {
