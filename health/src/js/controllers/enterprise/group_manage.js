...
//集团列表界面js文件
angular.module('app').controller('GroupManageCtrl', GroupManageCtrl);
GroupManageCtrl.$inject = ['$rootScope', '$scope', '$http', '$location', '$state', 'utils', 'modal'];
	function GroupManageCtrl($rootScope, $scope, $http, $location, $state, utils, modal) {
