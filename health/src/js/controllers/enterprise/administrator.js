...
AdminCtrl.$inject = ['$rootScope', '$scope', '$modal', '$log', '$http','toaster'];
function AdminCtrl($rootScope, $scope, $modal, $log, $http,toaster) {
...
//删除管理员模态框
angular.module('app').controller('removeModalInstanceCtrl', removeModalInstanceCtrl);
removeModalInstanceCtrl.$inject = ['$scope', '$modalInstance', 'item', '$http','toaster'];
function removeModalInstanceCtrl($scope, $modalInstance, item, $http,toaster) {
  var access_token = localStorage.getItem('access_token');
  var enterprise_doc_id = localStorage.getItem('enterprise_id');
  var enterprise_id = JSON.parse(localStorage.getItem('company')).id;
  $scope.ok = function() {
...
//邀请管理员模态框
angular.module('app').controller('inviteDocToManageModalCtrl', inviteDocToManageModalCtrl);
inviteDocToManageModalCtrl.$inject = ['$scope', '$modalInstance', '$http'];
function inviteDocToManageModalCtrl($scope, $modalInstance, $http) {
  var access_token = localStorage.getItem('access_token');
  var enterprise_doc_id = localStorage.getItem('enterprise_id');
  var enterprise_id = JSON.parse(localStorage.getItem('company')).id;
