...
// 登录控制器
angular.module('app').controller('forgotpwdCtrl', forgotpwdCtrl);
forgotpwdCtrl.$inject = ['$rootScope', '$scope', '$http', '$state', '$cookieStore', 'utils'];
    function forgotpwdCtrl($rootScope, $scope, $http, $state, $cookieStore, utils) {
