...
// 公司申请控制器
angular.module('app').controller('FillInfoController', FillInfoController);
FillInfoController.$inject = ['$scope', '$http', '$timeout', '$state', '$compile', 'Upload', 'utils'];
    function FillInfoController($scope, $http, $timeout, $state, $compile, Upload, utils) {
