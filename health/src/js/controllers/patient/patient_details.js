'use strict';
(function(){
    app.controller('PatientDetails',funcPatientDetails);
    funcPatientDetails.$inject=['$rootScope', '$scope', '$state', '$timeout', '$http', 'utils', '$stateParams'];
    function funcPatientDetails($rootScope, $scope, $state, $timeout, $http, utils, $stateParams) {
