...
app.controller('PatientOfDoctor', ['$rootScope', '$scope', '$state', '$timeout', '$http', 'utils', 'modal',function ($rootScope, $scope, $state, $timeout, $http, utils, modal) {
            ...
            $http({
                ...
                for (var i = 0; i < dt.length; i++) {
                    ...
                    var tdStr =
                        ...
                        '<td>' + (dt[i].ageStr ? dt[i].ageStr : dt[i].ageStr == '0' ? dt[i].ageStr : '') + '</td>' +
                        ...
                        "success": function (resp) {
                            ...
                            for (var i = 0; i < resp.data.pageData.length; i++) {
                                if(resp.data.pageData[i].doctor){
                                    ...
                                    utils.extendHash(resp.data.pageData[i], ["name", "ageStr", "sex", "telephone"], [doctor.name,null,null,doctor.telephone]);
                                }else{
                                    utils.extendHash(resp.data.pageData[i], ["name", "ageStr", "sex", "telephone"]);
                                }
                            }
