...
'use strict';
(function() {
    angular.module('app').controller('docRecommendListCtrl', funDocRecommendListCtrl);

    funDocRecommendListCtrl.$inject = ['$scope', '$http', '$state', 'utils', '$modal', 'toaster'];

    function funDocRecommendListCtrl($scope, $http, $state, utils, $modal, toaster) {
        ...
        $scope.selectDoctor = function() {
            ...
            var databox = new DataBox('data_res', {
                ...
                async: {
                    url: app.url.yiliao.getDepartmentRecommendDoctor,
                    dataKey: {
                        departmentId: 'id'
                    },
                    data: {
        ...
        $scope.funGetDoctorList = (function _funGetDoctorList(pageIndex, pageSize) {
            ...
            $http.post(app.url.doctor.getRecommendDocList, {
                ...
                if (rpn && rpn.resultCode == 1) {
                    ...
                    $scope.page_total = rpn.data.total;
...
angular.module('app').controller('offlineModalContentCtrl', offlineModalContentCtrl);
