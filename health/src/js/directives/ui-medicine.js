(function () {
    ...
    angular.module('app').directive('uiMedicine', ['$timeout', '$rootScope', '$parse', '$http',function($timeout, $rootScope, $parse, $http) {
        var templateStr = '<div class="commsearch"><div class="mask"></div>' +
            ...
            '<div>' +
            '<div class="h3 m-t-xs m-b-xs ng-binding">{{l.title}}</div>' +
