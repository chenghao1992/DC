        ...
        function($controllerProvider, $compileProvider, $filterProvider, $provide, $stateProvider) {
            ...
            app.url = {
                ...
                yiliao: {
                    ...
                    patient:serverApiRoot +'group/stat/groupPatient',
                ...
                designer:{
                    ...
                    //获取病情跟踪问题的按频率提问信息
                    getQuestionRepeatAsk:serverApiRoot+'designer/illnessTrack/getQuestionRepeatAsk',
                    //保存病情跟踪问题的按频率提问信息
                    saveQuestionRepeatAsk:serverApiRoot+'designer/illnessTrack/saveQuestionRepeatAsk',
                    //获取关怀项按频率重复提问信息
                    getRepeatFrequency:serverApiRoot+'designer/getRepeatFrequency',
                     //保存关怀项的按频率重复提问信息
                    saveRepeatFrequency:serverApiRoot+'designer/saveRepeatFrequency',
                    /// 添加关怀项-生活量表
                    saveLifeScaleItem:serverApiRoot+'designer/saveLifeScaleItem'
                ...
                care: {
                    ...
                    //眼科集团
                    getGroupId:eyeApiRoot+'doctorSchedule/getGroupId',
