(function() {
    ...
    // 手动注入依赖
    QuickReplyFactory.$inject = ['$http','constants'];

    function QuickReplyFactory($http,constants) {
        return {
        ...
        function getQuickReplyList(param) {
            ...
            return $http.post(constants.api.im.getQuickReplyList, param)
        ...
        function updateQuickReply(param) {
            ...
            return $http.post(constants.api.im.updateQuickReply, param)
                .then(getListsComplete)
                .catch(getListsFailed);
        };
        ...
        function addQuickReply(param) {
            ...
            return $http.post(constants.api.im.addQuickReply, param)
                .then(getListsComplete)
                .catch(getListsFailed);
        };
        ...
        function removeQuickReply(param) {
            ...
            return $http.post(constants.api.im.removeQuickReply, param)
                .then(getListsComplete)
                .catch(getListsFailed);
        };
