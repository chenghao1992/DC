...
'use strict';
(function () {
    app.controller('GuiderAccountCtrl', ['$scope','utils','$http','$modal','toaster','$location','$state','$rootScope','$stateParams','$filter',function($scope,utils,$http,$modal,toaster,$location,$state,$rootScope,$stateParams,$filter) {
