...
angular.module('app').controller('OIngDetails', OIngDetails);
OIngDetails.$inject = ['$scope', '$http', '$state', '$rootScope', 'utils', 'uiLoad', 'JQ_CONFIG', '$compile','$stateParams'];
function OIngDetails($scope, $http, $state, $rootScope, utils, uiLoad, JQ_CONFIG, $compile,$stateParams) {
