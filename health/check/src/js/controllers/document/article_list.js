// 'use strict';
(function () {
    app.controller('CheckArticleListCtrl', ['$scope', '$timeout','utils','$http','modal','toaster','$location','$state','$rootScope',function($scope, $timeout,utils,$http,modal,toaster,$location,$state,$rootScope) {
        ...
        $scope.createArticle=function(){
            $state.go('app.document.create_article',null,{reload:true});
        };
        ...
        var editArticle=function(aData){
            $state.go('app.document.edit_article',{id:aData.id},{'reload':true});
        };
