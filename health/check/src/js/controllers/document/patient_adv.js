...
'use strict';
(function () {
    app.controller('PatientADCtrl', ['$scope', '$timeout','utils','$http','modal','toaster','$location','$state','$rootScope',function($scope, $timeout,utils,$http,modal,toaster,$location,$state,$rootScope) {
        //所有文档表格
        var articleTable;
        ...
        var editArticle=function(aData){
            $state.go('app.document.edit_patient_ad',{id:aData.id},{'reload':true});
        };
