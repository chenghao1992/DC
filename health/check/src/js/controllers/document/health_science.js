(function () {
    app.controller('HealthScienceCtrl', ['$scope', '$timeout','utils','$http','modal','toaster','$location','$state','$rootScope',function($scope, $timeout,utils,$http,modal,toaster,$location,$state,$rootScope) {
        ...
        var editArticle=function(aData){
            $state.go('app.document.edit_health_science',{id:aData.id},{'reload':true});
        };
