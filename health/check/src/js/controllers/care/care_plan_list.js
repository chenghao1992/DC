...
(function () {
    //健康关怀列表
    app.controller('CarePlanListCtrl', ['$rootScope', '$scope', '$state', '$http', '$compile', 'utils', 'modal', 'toaster',function($rootScope, $scope, $state, $http, $compile, utils, modal, toaster) {
