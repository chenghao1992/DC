...
(function () {
    //日程题库
    app.controller('ReserveSfScheduleCtrl', ['$rootScope', '$scope', '$state', '$http', '$compile', 'utils', '$modal', 'toaster',function($rootScope, $scope, $state, $http, $compile, utils, $modal, toaster) {
    ...
    //详情弹窗
    app.controller('viewPopCtrl', ['$rootScope', '$scope', '$modalInstance', '$http', 'utils', 'viewData',function($rootScope, $scope, $modalInstance, $http, utils, viewData) {
