...
(function () {
    //日程题库
    app.controller('FollowUpTableCtrl', ['$rootScope', '$scope', '$state', '$http', '$compile', 'utils', '$modal', 'toaster',function($rootScope, $scope, $state, $http, $compile, utils, $modal, toaster) {
        ...
        function setTable(info) {
            ...
            $http.post(app.url.care.findFollowUpTemplates, {
                access_token:  app.url.access_token || localStorage.getItem('check_access_token'),
                //groupId: localStorage.getItem('curGroupId'),
                categoryId: info.id
            }).
        ...
        function getView(data) {
            ...
            //获取题库详情数据
            $http.post(app.url.care.queryCareTemplateItemDetailByCare, {
                access_token:  app.url.access_token || localStorage.getItem('check_access_token'),
    ...
    //添加随访
    app.controller('viewPopCtrl', ['$rootScope', '$scope', '$modalInstance', '$state', '$http', 'utils', 'toaster',function($rootScope, $scope, $modalInstance, $state, $http, utils, toaster) {
        $scope.viewName = "添加随访"
        ...
        function setTree(argument) {
            ...
            function setTable(info) {
                ...
                function addFollow(data) {
                    console.log(data);
                    $http.post(app.url.care.saveCareTemplateByCare, {
                        access_token:  app.url.access_token || localStorage.getItem('check_access_token'),
                        categoryId: info.id,
                        type: 2,
                        //groupId: localStorage.getItem('curGroupId'),
    ...
    //详情弹窗
    app.controller('ifonPopCtrl', ['$rootScope', '$scope', '$modalInstance', '$sce', '$state', '$http', 'utils', 'toaster', 'viewData',function($rootScope, $scope, $modalInstance, $sce, $state, $http, utils, toaster, viewData) {
        ...
        $scope.delete = function() {
            ...
            $http.post(app.url.care.deleteCareTempateByCare, {
                access_token:  app.url.access_token || localStorage.getItem('check_access_token'),
