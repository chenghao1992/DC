...
(function () {
    //日程题库
    app.controller('NewFollowUpCtrl', ['$rootScope', '$scope', '$state', '$http', '$stateParams', '$compile', 'utils', '$modal', 'toaster',function($rootScope, $scope, $state, $http, $stateParams, $compile, utils, $modal, toaster) {
...
// 设置提醒内容
    app.controller('NewFollowUp_TextDialogCtrl', ['$scope', '$modalInstance', 'toaster',function($scope, $modalInstance, toaster) {
...
// 调整时间
    app.controller('NewFollowUp_TimeDialogCtrl', ['$scope', '$modalInstance', 'toaster', 'data',function($scope, $modalInstance, toaster, data) {
...
//选择病种弹窗
    app.controller('NewFollowUp_DiseaseSelected', ['$rootScope', '$scope', '$modalInstance', '$http', 'utils', 'toaster',function($rootScope, $scope, $modalInstance, $http, utils, toaster) {
...
// 添加调查表或生活量表
    app.controller('NewFollowUp_AddListCtrl', ['$rootScope', '$scope', '$modalInstance', '$state', '$http', 'toaster', 'data',function($rootScope, $scope, $modalInstance, $state, $http, toaster, data) {
...
// 添加教患资料
    app.controller('NewFollowUp_docModalInstanceCtrl', ['$scope', '$modalInstance', 'toaster', '$http', 'utils',function($scope, $modalInstance, toaster, $http, utils) {
