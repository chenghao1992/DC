...
//品种库管理
angular.module('app').controller('copyVarietyInfoCtrl', copyVarietyInfoCtrl);
copyVarietyInfoCtrl.$inject = ['$scope', '$timeout', 'utils', '$http', '$modal', 'toaster', '$state', '$stateParams', '$sce'];
function copyVarietyInfoCtrl($scope, $timeout, utils, $http, $modal, toaster, $state, $stateParams, $sce) {
    //初始化参数
