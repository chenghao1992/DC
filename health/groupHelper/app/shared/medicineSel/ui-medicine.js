...
angular.module('app').directive('uiMedicine', function($timeout, $rootScope, $parse, $http,constants) {
    var templateStr = '<div class="commsearch"><div class="mask"></div>' +
        ...
        '<img class="pull-left b-3x m-r" sb-load="onImgLoad($event)" src="{{l.image_url | filterUndefined}}" />' +
        '<div>' +
    ...
    return {
        ...
        link: function($scope, element, attr) {
            ...
            $scope.findDrugByKeyWord = function() {
                ...
                if (key == "") return;
                var query_for_drug_company_url = "/web/api/invoke/" + localStorage.getItem('groupHelper_access_token') + "/c_Goods.select";
