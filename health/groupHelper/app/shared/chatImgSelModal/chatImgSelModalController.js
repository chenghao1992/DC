(function() {
    ...
    ChatImgSelModalInstanceCtrl.$inject = ['$scope', '$uibModalInstance', 'toaster', '$http','images','gId','constants'];

    function ChatImgSelModalInstanceCtrl($scope, $uibModalInstance, toaster, $http,images,gId,constants) {
        $http.post(constants.api.order.getDialogueImg, {
