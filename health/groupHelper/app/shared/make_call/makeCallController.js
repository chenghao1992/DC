(function() {
    ...
    MakeCallCtrl.$inject = ['$scope', '$uibModalInstance', 'toaster', 'MakeCallFactory', 'data','constants'];

    function MakeCallCtrl($scope, $uibModalInstance, toaster, MakeCallFactory, data,constants) {
