(function() {
    ...
    // 手动注入依赖
    myOrderCtrl.$inject = ['$scope', '$state', 'moment', 'toaster', 'MyOrderFactory', 'EditorConsultingRecordFactory','constants'];

    // 我的订单控制器
    function myOrderCtrl($scope, $state, moment, toaster, MyOrderFactory, EditorConsultingRecordFactory,constants) {
        $scope.pageIndex = 0;
        $scope.pedding=true;
