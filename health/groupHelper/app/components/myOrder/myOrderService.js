(function() {
    ...
    // 手动注入依赖
    MyOrderFactory.$inject = ['$http','constants'];

    function MyOrderFactory($http,constants) {
        return {
        ...
        function getGuideNoServiceOrder(param) {
            ...
            return $http.post(constants.api.order.getGuideNoServiceOrder, param)
        ...
        function getGuideAlreadyServicedOrder(param) {
            ...
            return $http.post(constants.api.order.getGuideAlreadyServicedOrder, param)
                .then(getListsComplete)
                .catch(getListsFailed);
        };
    };
