...
angular.module('app').controller('substanceEdit', ['$rootScope', '$scope', '$modal', '$log', '$http', '$state', 'constants', '$stateParams', '$timeout', 'toaster', 'ChooseHospitalsFactory',

    function($rootScope, $scope, $modal, $log, $http, $state, constants, $stateParams, $timeout, toaster, ChooseHospitalsFactory) {

        
        var user = JSON.parse(localStorage.getItem('user'));

        // 获取当前组织信息
        $scope.currentOrgInfo = user.curentGroup;
        ...
        $scope.funSaveData = function(currentHospitals) {
            ...
            modal.result.then(function() {
                ...
                $http.post(constants.api.substance.setGroupHospital, {
                    access_token: localStorage['groupHelper_access_token'],
...
//地图选择地址模态框
angular.module('app').controller('selectAddressInstanceCtrl', ['$scope', '$modalInstance','$http','$timeout','toaster','item', function($scope, $modalInstance, $http,$timeout,toaster,item) {
    var access_token = localStorage['groupHelper_access_token'];
...
//弹出确认提交模态框
angular.module('app').controller('confirmModalInstanceCtrl', ['$scope', '$modalInstance','toaster', function ($scope, $modalInstance, toaster) {
    $scope.ok = function () {
