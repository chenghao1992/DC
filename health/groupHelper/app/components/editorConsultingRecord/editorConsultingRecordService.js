(function() {
    ...
    // 手动注入依赖
    EditorConsultingRecordFactory.$inject = ['$http', '$uibModal','constants'];

    function EditorConsultingRecordFactory($http, $uibModal,constants) {
        return {
            open: open,
        ...
        function confirm(param) {
            ...
            return $http.post(constants.api.guider.confirm, param)
        ...
        function findByOrder(param) {
            ...
            return $http.post(constants.api.order.findByOrder, param)
                .then(getListsComplete)
                .catch(getListsFailed);
        };
        ...
        function createCurrecord(param) {
            ...
            return $http.post(constants.api.doctor.createCurrecord, param)
                .then(getListsComplete)
                .catch(getListsFailed);
        };
        ...
        function updateCurrecord(param) {
            ...
            return $http.post(constants.api.doctor.updateCurrecord, param)
                .then(getListsComplete)
                .catch(getListsFailed);
        };
        ...
        function getConsultVoice(param) {
            ...
            return $http.post(constants.api.order.getVoiceByOrderId, param)
                .then(getListsComplete)
                .catch(getListsFailed);
        };
