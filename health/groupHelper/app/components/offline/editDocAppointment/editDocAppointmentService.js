(function() {
    angular.module('app')
        .factory('EditDocAppointmentFactory', EditDocAppointmentFactory);

    // 手动注入依赖
    EditDocAppointmentFactory.$inject = ['$http','$uibModal','constants'];

    function EditDocAppointmentFactory($http,$uibModal,constants) {
        return {
            getIntro: getIntro,
            basicInfo: basicInfo,
        ...
        function openModal(options) {
            var modalInstance = $uibModal.open({
                templateUrl: './app/components/offline/editDocAppointment/editDocAppointmentView.html',
                controller: 'EditDocAppointmentCtrl',
                size: 'lg',
                resolve: {
                    data: options
                }
