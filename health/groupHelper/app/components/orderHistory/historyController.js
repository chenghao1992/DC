(function() {
    ...
    // 手动注入依赖
    orderHistoryCtrl.$inject = ['$scope', 'OrderHistoryFactory', '$sce', '$location', 'Lightbox','DoctorInfoDailogFtory','constants'];

    // 订单记录控制器
    function orderHistoryCtrl($scope, OrderHistoryFactory, $sce, $location, Lightbox,DoctorInfoDailogFtory,constants) {
