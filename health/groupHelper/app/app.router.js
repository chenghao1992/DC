    ...
    function config($stateProvider, $urlRouterProvider, $httpProvider, $provide) {
        ...
        $stateProvider
                        ...
                        function($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                files: [
                                    ...
                                    // searchOrderModal
                                    'app/shared/searchOrderModal/searchOrderModalController.js',
                                    'app/shared/searchOrderModal/searchOrderModalService.js',
                                    '../components/xg-table/fe-table.js',

                                    // orderDetailModal
                                    'app/shared/orderDetailModal/orderDetailModalController.js',
                                    'app/shared/orderDetailModal/orderDetailModalService.js',
                                ]
                            });
                        }
                    ]
            ...
            .state('order.outLine', {
                ...
                views: {
                    '': {
                        templateUrl: 'app/components/outLine/outLineView.html',
                        ...
                        function($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                files: [
                                    'ui.select',
                                    // care
                                    'app/components/outLine/outLineService.js',
                                    'app/components/outLine/outLineController.js',
                                    // doctorInfoDailog
                                    'app/shared/doctorInfoDailog/doctorInfoDailogDirective.js',
                                    'app/shared/doctorInfoDailog/doctorInfoDailogService.js',
                                    'app/shared/doctorInfoDailog/doctorInfoDailogController.js',
                ...
                resolve: {
                    lazy: ['$ocLazyLoad',
                        function($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                files: [
                                    'app/components/offline/offlineCtrl.js',

                                    // editRemarksModal
                                    'app/components/offline/editRemarksModal/editRemarksModal.js',

                                    // editBookTimeModal
                                    'app/components/offline/editBookTimeModal/editBookTimeModal.js',
                                    ...
                                    // editCancelInfoModal
                                    'app/components/offline/editCancelInfoModal/editCancelInfoModal.js',

                                    //searchOffLineDoctorDialog
                                    'app/components/offline/searchOffLineDoctorDialog/searchOffLineDoctorDialogController.js',
                                    'app/components/offline/searchOffLineDoctorDialog/searchOffLineDoctorDialogService.js',

                                    //editDocAppointment
                                    'app/components/offline/editDocAppointment/editDocAppointmentController.js',
                                    'app/components/offline/editDocAppointment/editDocAppointmentService.js',
                                    ...
                                    //editDocAppointment
                                    'app/components/offline/addAppointment/addAppointmentController.js',
                                    'app/components/offline/addAppointment/addAppointmentService.js',
                                    ...
                                    'app/shared/sureDialog/sureDialogFactory.js'
                                ]
                            });
                        }
                    ]
                ...
                resolve: {
                    lazy: ['$ocLazyLoad',
                        function($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                files: [
                                    'app/components/scheduling/schedulingCtrl.js',

                                    // editSchedulingModal
                                    'app/shared/editSchedulingModal/editSchedulingModalService.js',
                                    'app/shared/editSchedulingModal/editSchedulingModalCtrl.js',

                                    // sureSchedulingModal
                                    'app/shared/sureSchedulingModal/sureSchedulingModalService.js',
                                    'app/shared/sureSchedulingModal/sureSchedulingModalCtrl.js',
                                    
                                    // timeScheduling
                                    'app/shared/time_scheduling/timeSchedulingDirective.js',
                                    'app/shared/time_scheduling/timeSchedulingCtrl.js',
                                ]
                            });
                        }
                    ]
            ...
            .state('order.substance', {
                title: '线下执业医院',
                url: '/substance',
                views: {
                    '': {
                        templateUrl: 'app/components/substance/substance.html'
                    }
                },
                resolve: {
                    lazy: ['$ocLazyLoad',
                        function($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                files: [
                                    'app/components/substance/substanceCtrl.js',
                                    'app/shared/chooseHospitals/chooseHospitals.js'
                                ]
                            });
                        }
                    ]
