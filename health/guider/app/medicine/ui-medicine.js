        ...
        return {
            ...
            link: function($scope, element, attr) {
                ...
                $scope.findDrugByKeyWord = function() {
                    ...
                    var query_for_drug_company_url = "/web/api/invoke/2/" + localStorage.getItem('guider_access_token') + "/c_Goods.select";
                    var set_good_state_url = "/web/api/invoke/" + localStorage.getItem('guider_access_token') + "/c_GoodsOnStack.set_good_state";
                    var url = '';
