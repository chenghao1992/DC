...
(function() {
    ...
    // 手动注入依赖
    NewPassWordCtrl.$inject = ['$scope', '$state', 'NewPassWordFactory','$stateParams','$http','constants'];

    // 登录控制器
    function NewPassWordCtrl($scope, $state, NewPassWordFactory,$stateParams,$http,constants) {
        ...
        $scope.reset=function(){
            ...
            $http.post(constants.api.shared.resetPassword, {
                phone:phone,
                userType:6,
                smsid:smsid,
                ranCode:ranCode,
