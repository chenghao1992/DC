(function() {
    ...
    // 手动注入依赖
    ConsultingRecordFactory.$inject = ['$http','constants'];

    function ConsultingRecordFactory($http,constants) {
        return {
        ...
        function findByPatientAndDoctor(param) {
            ...
            return $http.post(constants.api.order.findByPatientAndDoctor, param)
