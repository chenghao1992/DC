(function() {
    ...
    function ThreeWayCallingFactory($http,constants) {
        return {
        ...
        function removeConference(param) {
            ...
            return $http.post(constants.api.conference.removeConference, param)
        ...
        function inviteMember(param) {
            ...
            return $http.post(constants.api.conference.inviteMember, param)
                .then(getListsComplete)
                .catch(getListsFailed);
        ...
        function unDeafConference(param) {
            ...
            return $http.post(constants.api.conference.unDeafConference, param)
                .then(getListsComplete)
                .catch(getListsFailed);
        ...
        function deafConference(param) {
            ...
            return $http.post(constants.api.conference.deafConference, param)
                .then(getListsComplete)
                .catch(getListsFailed);
        ...
        function conferenceGetStatus(param) {
            ...
            return $http.post(constants.api.conference.conferenceGetStatus, param)
                .then(getListsComplete)
                .catch(getListsFailed);
        ...
        function createConference(param) {
            ...
            return $http.post(constants.api.conference.createConference, param)
                .catch(getListsFailed);
        ...
        function dismissConference(param) {
            ...
            return $http.post(constants.api.conference.dismissConference, param)
                .then(getListsComplete)
                .catch(getListsFailed);
