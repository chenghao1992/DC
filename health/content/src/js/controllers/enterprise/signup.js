...
// 公司注册控制器
angular.module('app').controller('SignupFormController', SignupFormController);
SignupFormController.$inject = ['$scope', '$http', '$state', 'utils'];
    function SignupFormController($scope, $http, $state, utils) {
