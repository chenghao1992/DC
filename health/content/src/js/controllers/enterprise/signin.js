...
// 公司登录控制器
angular.module('app').controller('enterpriseSigninFormController', enterpriseSigninFormController);
enterpriseSigninFormController.$inject = ['$scope', '$http', '$state', '$cookieStore', 'utils', '$rootScope'];
    function enterpriseSigninFormController($scope, $http, $state, $cookieStore, utils, $rootScope) {
