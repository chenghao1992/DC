...
SettingCtrl.$inject = ['$scope', '$modal', '$log'];
function SettingCtrl($scope, $modal, $log) {
...
angular.module('app').controller('inviteDocCreateGroupModalCtrl', inviteDocCreateGroupModalCtrl);
inviteDocCreateGroupModalCtrl.$inject = ['$scope', '$modalInstance', '$http'];
function inviteDocCreateGroupModalCtrl($scope, $modalInstance, $http) {
