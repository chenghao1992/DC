'use strict';
(function(){
    app.controller('InvitePatient',funcInvitePatient);
    funcInvitePatient.$inject=['$rootScope', '$scope', '$state', '$timeout', '$http', 'utils', 'modal', '$modal'];
    function funcInvitePatient($rootScope, $scope, $state, $timeout, $http, utils, modal, $modal) {
