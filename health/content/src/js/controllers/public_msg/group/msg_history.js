...
(function(){
    app.controller('MsgHistoryCtrl',funcMsgHistoryCtrl);
    funcMsgHistoryCtrl.$inject=['$scope', '$timeout','utils','$http','$modal','toaster','$location','$state','$stateParams'];
    function funcMsgHistoryCtrl($scope, $timeout,utils,$http,$modal,toaster,$location,$state,$stateParams) {
        var docArticleTable;
