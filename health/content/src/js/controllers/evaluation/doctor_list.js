...
angular.module('app').controller('DoctorList', DoctorList);

DoctorList.$inject = ['$rootScope', '$scope', '$state', '$http', 'utils', 'Doctor'];

function DoctorList($rootScope, $scope, $state, $http, utils, Doctor) {
    ...
    $scope.return = function() {
        $state.go('app.evaluation.by_doctor', {}, {
            reload: false
        });
        //window.history.back();
    };
