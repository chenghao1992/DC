...
angular.module('app').controller('DoctorDetails', DoctorDetails);

DoctorDetails.$inject = ['$rootScope', '$scope', '$state', '$timeout', '$http', 'utils'];

function DoctorDetails($rootScope, $scope, $state, $timeout, $http, utils) {
    ...
    $scope.viewData.contactWay = $scope.doctorInfo.contactWay || '--';
    $scope.viewData.remarks = $scope.doctorInfo.remarks || '--';
    ...
    $scope.cancel = function() {
        ...
        //window.history.back();
        //$state.go('app.contacts.list');
        $state.go('app.doctor_list', {
            id: $scope.curDoctorId
        }, {
            reload: true
        });
        html.css('overflow', 'auto');
