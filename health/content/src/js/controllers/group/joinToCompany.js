...
(function(){
    //集团加入公司控制器
    app.controller('joinToCompanyCtrl',funcjoinToCompanyCtrl);
    funcjoinToCompanyCtrl.$inject=['$rootScope', '$scope', '$state', '$timeout', '$http', 'utils'];
    function funcjoinToCompanyCtrl($rootScope, $scope, $state, $timeout, $http, utils) {
