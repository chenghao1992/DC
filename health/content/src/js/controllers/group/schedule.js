...
(function(){
    app.controller('ScheduleCtrl',funcScheduleCtrl);
    funcScheduleCtrl.$inject=['$rootScope', '$scope', '$http', '$log', 'utils', '$state', '$modal', 'toaster'];
    function funcScheduleCtrl($rootScope, $scope, $http, $log, utils, $state, $modal, toaster) {
        ...
        function forward(info) {
            ...
            $scope.getOnlineId = function(weekday, stage) {
                if ($scope.depData.clinicDate == undefined) {} else {
