...
(function(){
    //集团设置控制器
    app.controller('groupSettingsCtrl',funcgroupSettingsCtrl);
    funcgroupSettingsCtrl.$inject=['$rootScope', '$scope', '$modal', '$log', '$http', '$state', '$stateParams','utils', 'toaster' ];
    function funcgroupSettingsCtrl($rootScope, $scope, $modal, $log, $http, $state, $stateParams, utils, toaster) {
...
(function(){
    //集团LOGO设置控制器
    app.controller('groupLogoSettingsCtrl',funcgroupLogoSettingsCtrl);
    funcgroupLogoSettingsCtrl.$inject=['$scope', '$modal', '$log', '$http', 'Upload', '$stateParams', '$state','toaster', 'utils'];
    function funcgroupLogoSettingsCtrl($scope, $modal, $log, $http, Upload, $stateParams, $state, toaster, utils) {
