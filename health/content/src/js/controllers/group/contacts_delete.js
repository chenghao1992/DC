'use strict';
(function(){
    app.controller('ContactsDelete',funcContactsDeleteCtrl);
    funcContactsDeleteCtrl.$inject=['$rootScope', '$scope', '$state', '$timeout', '$http', 'utils', 'modal'];
    function funcContactsDeleteCtrl($rootScope, $scope, $state, $timeout, $http, utils, modal) {
