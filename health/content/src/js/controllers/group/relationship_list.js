'use strict';
(function(){
    app.controller('RelationshipList',funcRelationshipList);
    funcRelationshipList.$inject=['$rootScope', '$scope', '$state', '$timeout', '$http', 'utils'];
    function funcRelationshipList($rootScope, $scope, $state, $timeout, $http, utils) {
