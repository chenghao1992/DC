'use strict';
(function(){
  app.controller('RelationshipDelete',funcRelationshipDelete);
  funcRelationshipDelete.$inject=['$scope', '$state', '$http', 'utils', 'modal'];
  function funcRelationshipDelete($scope, $state, $http, utils, modal) {
