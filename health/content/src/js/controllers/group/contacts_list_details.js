'use strict';
(function(){
    app.controller('ContactsListDetails',funcContactsListDetails);
    funcContactsListDetails.$inject=['$rootScope', '$scope', '$state', '$timeout', '$http', 'utils', '$stateParams'];
    function funcContactsListDetails($rootScope, $scope, $state, $timeout, $http, utils, $stateParams) {
