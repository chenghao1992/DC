'use strict';
(function(){
    app.controller('ContactsInvite',funcContactsInvite);
    funcContactsInvite.$inject=['$rootScope', '$scope', '$state', '$timeout', '$http', 'utils', 'modal'];
    function funcContactsInvite($rootScope, $scope, $state, $timeout, $http, utils, modal) {
        ...
        $scope.cancel = function () {
            if(typeof $rootScope.ReInitStatusList=='function'){
                $rootScope.ReInitStatusList();
            }
            if(typeof $rootScope.ReInitStatusList=='function'){
                $rootScope.initContacsTable();
