...
angular.module('app').controller('BankAccount', BankAccount);
BankAccount.$inject = ['$rootScope', '$scope', '$state', '$timeout', '$http', 'utils', 'modal', '$modal'];
    function BankAccount($rootScope, $scope, $state, $timeout, $http, utils, modal, $modal) {
...
angular.module('app').controller('AddBankAccount', AddBankAccount);

AddBankAccount.$inject = ['$scope', '$rootScope', '$modalInstance', '$http', 'item', 'modal'];

function AddBankAccount($scope, $rootScope, $modalInstance, $http, item, modal) {
    $scope.account = {};
