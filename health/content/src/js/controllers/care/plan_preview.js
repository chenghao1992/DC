...
//健康关怀列表
angular.module('app').controller('PlanPreviewCtrl', PlanPreviewCtrl);

PlanPreviewCtrl.$inject = ['$rootScope', '$scope', '$state', '$http', '$compile', 'utils', '$modal', 'toaster', '$stateParams'];

function PlanPreviewCtrl($rootScope, $scope, $state, $http, $compile, utils, $modal, toaster, $stateParams) {
