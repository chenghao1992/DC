...
//病情跟踪题库
angular.module('app').controller('QuestionsOfDiseaseCtrl', QuestionsOfDiseaseCtrl);

QuestionsOfDiseaseCtrl.$inject = ['$rootScope', '$scope', '$state', '$http', '$compile', 'utils', '$modal', 'toaster'];

function QuestionsOfDiseaseCtrl($rootScope, $scope, $state, $http, $compile, utils, $modal, toaster) {
...
//详情弹窗
angular.module('app').controller('viewPopCtrl2', viewPopCtrl2);

viewPopCtrl2.$inject = ['$rootScope', '$scope', '$modalInstance', '$http', 'utils', 'viewData'];

function viewPopCtrl2($rootScope, $scope, $modalInstance, $http, utils, viewData) {
