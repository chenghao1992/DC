'use strict';
(function() {
    angular.module('app').factory('AddSurveyFtory', AddSurveyFtory);
    ...
    angular.module('app').controller('AddSurveyCtrl', AddSurveyCtrl);

    AddSurveyCtrl.$inject = ['$scope', '$http', '$modal', '$modalInstance','toaster','surveyData'];

    function AddSurveyCtrl($scope, $http, $modal, $modalInstance, toaster, surveyData) {
        //预览弹窗
       $scope.surveyCheck = function(lifeScaleId, version) {
            var modalInstance = $modal.open({
                animation: true,
                templateUrl: 'surveyChickCtrl.html',
                controller: 'ModalSurveyChickCtrl',
                size: 'lg',
                resolve: {
                    lifeid: function() {
                        return lifeScaleId;
...
angular.module('app').controller('ModalSurveyChickCtrl', ModalSurveyChickCtrl);

ModalSurveyChickCtrl.$inject = ['$scope', '$http', '$modal', '$modalInstance','toaster','lifeid', 'version'];

function ModalSurveyChickCtrl($scope, $http, $modal, $modalInstance, toaster,lifeid,version){
    if (lifeid && version) {
