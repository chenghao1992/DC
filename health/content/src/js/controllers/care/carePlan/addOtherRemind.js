'use strict';
(function() {
    angular.module('app').factory('AddCareRemindFtory', AddCareRemindFtory);
    ...
    angular.module('app').controller('AddCareRemindCtrl', AddCareRemindCtrl);

    AddCareRemindCtrl.$inject = ['$scope', '$http', '$modal', '$modalInstance','toaster','remindData'];
