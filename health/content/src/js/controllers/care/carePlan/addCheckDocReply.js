'use strict';
(function() {
    angular.module('app').factory('AddCheckDocReplyFtory', AddCheckDocReplyFtory);
    ...
    angular.module('app').controller('AddCheckDocReplyCtrl', AddCheckDocReplyCtrl);

    AddCheckDocReplyCtrl.$inject = ['$scope', '$http', '$modal', '$modalInstance','toaster','replyData'];
