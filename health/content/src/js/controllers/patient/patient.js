'use strict';
(function(){
    app.controller('Patient',funcPatient);
    funcPatient.$inject=['$rootScope', '$scope', '$state', '$http', '$compile', 'utils', '$stateParams'];
    function funcPatient($rootScope, $scope, $state, $http, $compile, utils, $stateParams) {
        var data = null,
            cnt_list = $('#cnt_list'),
