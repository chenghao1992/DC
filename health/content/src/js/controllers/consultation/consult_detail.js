...
angular.module('app').controller('ConsultDetailCtrl', ConsultDetailCtrl);

ConsultDetailCtrl.$inject = ['$scope', 'utils', '$http', '$modal','toaster','$location', '$state', '$rootScope', '$stateParams'];

function ConsultDetailCtrl($scope,utils,$http,$modal,toaster,$location,$state,$rootScope,$stateParams) {
