'use strict';
(function(){
    app.controller('DataAdd',funcDataAdd);
    funcDataAdd.$inject=['$rootScope', '$scope', '$state', '$timeout', '$http', 'utils'];
    function funcDataAdd($rootScope, $scope, $state, $timeout, $http, utils) {
