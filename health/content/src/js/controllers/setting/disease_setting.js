'use strict';
(function(){
    app.controller('DiseaseSettingCtrl',funcDiseaseSettingCtrl);
    funcDiseaseSettingCtrl.$inject=['$rootScope', '$scope', '$state', '$http', '$compile', 'utils', 'modal', 'toaster'];
    function funcDiseaseSettingCtrl($rootScope, $scope, $state, $http, $compile, utils, modal, toaster) {
        var data = null,
            cnt_list = $('#cnt_list'),
