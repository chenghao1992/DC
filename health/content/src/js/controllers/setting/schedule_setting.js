...
'use strict';
(function(){
    app.controller('ScheduleSetting',funcScheduleSetting);
    funcScheduleSetting.$inject=['$rootScope', '$scope', '$state', '$http', '$compile', 'utils', 'uiLoad', 'JQ_CONFIG', 'modal'];
    function funcScheduleSetting($rootScope, $scope, $state, $http, $compile, utils, uiLoad, JQ_CONFIG, modal){
        var data = null,
            cnt_list = $('#cnt_list'),
        ...
        $http({
            ...
            if (resp.data.resultCode === 1 && resp.data.data) {
                ...
                if (_len) {
                    ...
                    tempTimeForFree = $scope.formData.taskForFree = 8;
                }
        ...
        $scope.saveData = function () {
            ...
            if(!_bool && (tempStartTime == $scope.formData.startTime && tempEndTime == $scope.formData.endTime) && tempPrice == priceForTask){
