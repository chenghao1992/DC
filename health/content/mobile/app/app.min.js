    ...
    function config($stateProvider, $urlRouterProvider, $httpProvider, $compileProvider) {
        ...
        // 测试
            ...
            .state("bdjl.openApp", {
                ...
                views: {
                    '': {
                        template: "<open-app-bdjl doc='#医生' pat='#患者'>loading...</openApp>",
                        // template: "<a href='dachenappdoctor://data=1'>点解</a>",
                    }
                }
            })
    ...
    function openApp($location, $timeout, $stateParams) {
        return {
            ...
            controller: function($scope) {
                ...
                } else if ($stateParams.type == 'das') {

                    openUrl = openApp.das + param;
...
(function() {
    myApp
        .directive('openAppBdjl', openAppBdjl);

    function openAppBdjl($location, $timeout, $stateParams) {
        return {
            scope: {
                doc: '@',
                pat: '@',
            ...
            controller: function($scope) {
                ...
                var openUrl = '#',
                    noAppdown = '../bd_h5/appInvite/goDownApp.html';
                // 获取url的参数
                var url = $location.url();
                var arry = url.split('?');
                var param = arry[1] || '';
                ...
                if ($stateParams.type == 'doc') {
                    ...
                    iphoneUrl = '../bd_h5/app/downDoctor.html'; //'http://fir.im/xgys';
                    androidUrl = '../bd_h5/app/downDoctor.html'; //'http://fir.im/9kep';
                    noAppdown = noAppdown + '?downTye=doc';

                } else if ($stateParams.type == 'pat') {
                    openUrl = openApp.pat + param;

                    iphoneUrl = '../bd_h5/app/downPatient.html'; //'http://fir.im/xghz';
                    androidUrl = '../bd_h5/app/downPatient.html'; //'http://fir.im/rvg6';
                    noAppdown = noAppdown + '?downTye=pati';
