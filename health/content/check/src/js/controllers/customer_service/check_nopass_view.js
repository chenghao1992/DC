'use strict';
(function () {
    app.controller('CheckNopassView', ['$scope', '$http', '$state', '$rootScope', '$stateParams','utils', 'modal', 'ModelDialogFactory',
        function($scope, $http, $state, $rootScope, $stateParams,utils, modal, ModelDialogFactory) {
            ...
            $scope.checkAsPass = function() {
                ...
                // var modalContent = $('<span style="padding:0 150px;">是否确认审核通过22？</span>');

                // modal.confirm(null, modalContent, function() {
