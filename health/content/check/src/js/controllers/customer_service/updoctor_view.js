...
(function () {
    ...
    // app.controller('upDoctorViewCtlr', ['$scope', '$timeout', 'utils', '$http', '$modal', 'toaster', '$state', '$stateParams', '$sce','Upload',function($scope, $timeout, utils, $http, $modal, toaster, $state, $stateParams, $sce,Upload){
    //     $scope.document={
    //         isSaved:false,   //添加按钮
    //         isShow:false,     //进度条显示
    //         documentBtn:'选择需要导入的文件',   //btn按钮
    ...
    //     }
    // }]);
    // app.controller('checkModelDocterCtrl',['$scope','$modalInstance',function($scope,$modalInstance){
    //     $scope.ok=function(){
    //         $modalInstance.close('ok');
    //     }
    //     $scope.cancel=function(){
    ...
    //     }
    // }])
    // app.controller('errorModelDocterCtrl',['$scope','$modalInstance','item',function($scope,$modalInstance,item){
    //
    //     $scope.errorListData=item;
    //
    //     $scope.ok=function(){
    ...
    //     }
    // }])
    // app.controller('passModelDocterCtrl',['$scope','$modalInstance','item',function($scope,$modalInstance,item){
    //     $scope.listData=item;
    //     $scope.ok=function(){
    //         $modalInstance.close('ok');
    //     }
