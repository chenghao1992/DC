 ...
 */
angular.module('app').controller('MsgHistoryCtrl', MsgHistoryCtrl);
MsgHistoryCtrl.$inject = ['$scope', '$timeout','utils','$http','$modal','toaster','$location','$state','$stateParams'];
function MsgHistoryCtrl($scope, $timeout,utils,$http,$modal,toaster,$location,$state,$stateParams) {
    var docArticleTable;
