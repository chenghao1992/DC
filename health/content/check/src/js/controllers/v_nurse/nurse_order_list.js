...
angular.module('app').controller('NListGroup', NListGroup);
NListGroup.$inject = ['$rootScope', '$scope', '$state', '$timeout', '$http', 'utils', '$stateParams', 'modal'];
function NListGroup($rootScope, $scope, $state, $timeout, $http, utils, $stateParams, modal) {
