...
angular.module('app').controller('VCheckListGroup', VCheckListGroup);
VCheckListGroup.$inject = ['$rootScope', '$scope', '$state', '$timeout', '$http', 'utils', '$stateParams', 'modal'];
function VCheckListGroup($rootScope, $scope, $state, $timeout, $http, utils, $stateParams, modal) {
