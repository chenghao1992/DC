...
angular.module('app').controller('VNurse', VNurse);
VNurse.$inject = ['$scope', '$http', '$state', '$rootScope', 'utils', 'uiLoad', 'JQ_CONFIG', '$compile'];
function VNurse($scope, $http, $state, $rootScope, utils, uiLoad, JQ_CONFIG, $compile) {
        $scope.isPass = true;
