...
(function () {
    //病情跟踪题库
    app.controller('QuestionsOfDiseaseCtrl', ['$rootScope', '$scope', '$state', '$http', '$compile', 'utils', '$modal', 'toaster',function($rootScope, $scope, $state, $http, $compile, utils, $modal, toaster) {
...
//详情弹窗
    app.controller('viewPopCtrl2', ['$rootScope', '$scope', '$modalInstance', '$http', 'utils', 'viewData',function($rootScope, $scope, $modalInstance, $http, utils, viewData) {
