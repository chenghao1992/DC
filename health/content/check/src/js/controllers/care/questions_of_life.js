...
(function () {
    //生活量表库
    app.controller('QuestionsOfLifeCtrl', ['$rootScope', '$scope', '$state', '$http', '$compile', 'utils', '$modal', 'toaster',function($rootScope, $scope, $state, $http, $compile, utils, $modal, toaster) {
