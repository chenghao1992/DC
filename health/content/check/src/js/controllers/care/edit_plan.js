'use strict';
(function () {
    app.controller('EditCarePlanCtrl', ['$rootScope', '$scope', '$state', '$http', '$compile', 'utils', '$modal', 'toaster', '$stateParams',function($rootScope, $scope, $state, $http, $compile, utils, $modal, toaster, $stateParams) {
        ...
        $scope.deletePlan=function(){
            ...
            modalInstance.result.then(function (status) {
                if(status=='ok'){
                    $http.post(app.url.care.delCareTemplate, {
        ...
        $scope.editIntroduce=function(){
            ...
            $state.go('app.care_introduce',{planId:$stateParams.planId,isEdit:'edit'});
        };
        ...
        if ($stateParams.planId) {
            if($stateParams.isEdit=='edit'){
                ...
                //获取计划详情数据
                $http.post(app.url.care.queryCareTemplateDetail, {
                    access_token:  app.url.access_token || localStorage.getItem('check_access_token'),
                    templateId: $stateParams.planId
                }).
                then(function(rpn) {
...
//添加按钮弹窗
    app.controller('addPopCtrl', ['$rootScope', '$scope', '$modalInstance', '$http', 'utils', 'toaster', 'data',function($rootScope, $scope, $modalInstance, $http, utils, toaster, data) {
