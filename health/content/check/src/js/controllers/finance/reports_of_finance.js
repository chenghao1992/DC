...
ReportsOfFinance.$inject = ['$rootScope', '$scope', '$state', '$timeout', '$http', 'utils', '$stateParams', 'modal'];
function ReportsOfFinance($rootScope, $scope, $state, $timeout, $http, utils, $stateParams, modal) {
                ...
                "fnServerData": function (sSource, aoData, fnCallback) {
                    $http({
                        ...
                        for (var i = 0; i < resp.pageData.length; i++) {
                            utils.extendHash(resp.pageData[i], ["name", "status", "unsettlemoney", "settledMoney", "settleTime", "lastSettleTime"]);
                        }
...
/*                        var date = new Date(dt.createTime),
                    ...
                    "render": function (set, status, dt) {
                        if (set === 2) {
                            ...
                            return '<button class="btn btn-info mrr-10">查看</button>';
                        }
                    }
                }]
            });
