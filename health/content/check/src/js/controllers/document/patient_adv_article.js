...
'use strict';
(function () {
    app.controller('PatientADArticleCtrl', ['$scope', '$timeout','utils','$http','$modal','toaster','$location','$state','$rootScope','$stateParams','$sce',function($scope, $timeout,utils,$http,$modal,toaster,$location,$state,$rootScope,$stateParams,$sce) {
        $scope.showTop=false;
        ...
        $scope.editArticle=function(){
            alert('c')
            $state.go('edit_patient_ad',{id:$scope.article.id},{'reload':true});
        };
    }]);
