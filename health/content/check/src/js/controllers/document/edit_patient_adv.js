...
'use strict';
(function () {
    app.controller('PatientADEditCtrl', ['$scope', '$timeout', 'utils', '$http', '$modal', 'Upload', 'toaster', '$state', '$stateParams', '$sce','$log','$rootScope','modal',function($scope, $timeout, utils, $http, $modal, Upload, toaster, $state, $stateParams, $sce,$log,$rootScope,modal) {
        $scope.titleLength = 0;
