...
(function(){
    ...
    WeatherCtrl.$inject=['$scope', 'yahooApi', 'geoApi'];
    function WeatherCtrl($scope, yahooApi, geoApi) {
        $scope.userSearchText = '';
        $scope.search = {};
        $scope.forcast = {};
        $scope.place = {};
    ...
    app.factory('yahooApi',yahooApi);
    yahooApi.$inject=['$resource'];
    function yahooApi($resource){
        return $resource('http://query.yahooapis.com/v1/public/yql', {},
            {'query':
            {
                method: 'GET',
