(function(){
  ...
  function MailListCtrl(){
    $scope.fold = $stateParams.fold;
    mails.all().then(function(mails) {
      $scope.mails = mails;
    });
  };
  app.controller('MailDetailCtrl',MailDetailCtrl);
  ...
  app.controller('MailNewCtrl',MailNewCtrl);
...
//   }
// ]);
// app.controller('MailListCtrl', ['$scope', 'mails', '$stateParams',
...
//   }
// ]);
// app.controller('MailNewCtrl', ['$scope',
//   function($scope) {
//     $scope.mail = {
//       to: '',
//       subject: '',
