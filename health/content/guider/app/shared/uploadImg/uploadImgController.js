(function() {
    ...
    UploadImgController.$inject = ['$scope', 'FileUploader','constants'];

    function UploadImgController($scope, FileUploader,constants) {
        ...
        $scope.uploader = new FileUploader({
            url: constants.api.upLoad.commonUploadServlet
        });
