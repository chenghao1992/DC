(function() {
    ...
    PatientInfoDailogCtrl.$inject = ['$scope', '$uibModal', '$ocLazyLoad','constants'];

    function PatientInfoDailogCtrl($scope, $uibModal, $ocLazyLoad,constants) {
    ...
    PatientInfoDailogModalInstanceCtrl.$inject = ['$scope', '$uibModalInstance', 'toaster', 'data', 'PatientInfoDailogFtory', 'MakeCallFactory', 'Lightbox','constants'];

    function PatientInfoDailogModalInstanceCtrl($scope, $uibModalInstance, toaster, data, PatientInfoDailogFtory, MakeCallFactory, Lightbox,constants) {
