(function() {
    ...
    // 手动注入依赖
    ScheduleFactory.$inject = ['$http','constants'];

    function ScheduleFactory($http,constants) {
        return {
        ...
        function changeAppointTime(param) {
            ...
            return $http.post(constants.api.order.changeAppointTime, param)
        ...
        function scheduleTime(param) {
            ...
            return $http.post(constants.api.shared.scheduleTime, param)
        ...
        function scheduleDetail(param) {
            ...
            return $http.post(constants.api.shared.scheduleDetail, param)
                .then(getListsComplete)
                .catch(getListsFailed);
        };
        ...
        function getOrderRemarks(param) {
            ...
            return $http.post(constants.api.order.getOrderRemarks, param)
                .then(getListsComplete)
                .catch(getListsFailed);
        };
        ...
        function setRemarks(param) {
            ...
            return $http.post(constants.api.order.setRemarks, param)
                .catch(getListsFailed);
        };
