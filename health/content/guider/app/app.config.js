    ...
    var constants = {
        api: {
            ...
            order: {
                ...
                //导医回复患者消息
                replyPatientMessage:serverApiRoot+'guide/replyPatientMessage',

                //导医客服获取需要服务的患者列表
                getBeServicedPatients:serverApiRoot+'guide/getBeServicedPatients',

                //结束服务
                finish:serverApiRoot+'guide/finish',

                //获取当前月的记录列表
                getCustomerWorkDate:serverApiRoot+'guide/getCustomerWorkDate',

                //获取某一天的记录列表
                getDayRecords:serverApiRoot+'guide/getDayRecords',

                //导医获取患者信息
                getUserInfo:serverApiRoot+'guide/getUserInfo',
            },
        ...
        access_token: localStorage.getItem('guider_access_token') || null
