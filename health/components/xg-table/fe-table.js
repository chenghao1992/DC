...
angular.module('app').directive('feTable',function($filter){
    return{
        restrict:'AE',
        template:'<div>'+
        ...
        '<uib-pagination style="margin:10px 0;float: right" total-items="totalItems" ng-change="pageChanged()" items-per-page="itemPerPage" ng-model="currentPage" max-size="maxSize" class="pagination-sm" boundary-links="true" first-text="首页" last-text="尾页" previous-text="<" next-text=">"></uib-pagination>'+
        '</div>'+
        ...
        link:function($scope,element,attr){
            ...
            function init(_data){
                ...
                $scope.endItem=$scope.currentPage*$scope.itemPerPage>$scope.totalItems?$scope.totalItems:$scope.currentPage*$scope.itemPerPage;
